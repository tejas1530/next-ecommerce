...
export default function Home() {
  ...
  <div className="container px-5 sm:py-24 py-10 tracking-wider sm:tracking-widest mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Curated Collections for Every Taste</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Discover a fusion of elegance and innovation in every stitch, as we redefine fashion for those who dare to stand out.</p>
    </div>
